      ...
      <div className="footer-bottom">
         <div className="container">
             <div className="section-wraper">
               <p>&copy; 2025 <Link to='/'>Shop Cart</Link> Designed by <a href="#">ZakirBD</a> </p>
               <div className="footer-bottom-list" style={{float:'right'}}>
                  {
                    footerbottomList.map((val, i)=>(
                      <a style={{padding:'5px'}} href="#" key={i}>{val.text}</a>
                    ))
                  }
               </div>
             </div>
